...
This project features fusing measurements from LiDAR and camera and track vehicles over time. By using real-world data from the Waymo Open Dataset, object detection in 3D point clouds is conducted and then applied an extended Kalman filter for sensor fusion and tracking.
